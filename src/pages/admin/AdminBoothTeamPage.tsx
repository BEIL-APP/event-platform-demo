...
export default function AdminBoothTeamPage() {
  ...
  // Unassigned people (have a record without boothId, and no record for this booth)
  ...
  const handleAdd = () => {
    if (!newEmail.includes('@') || !newName.trim() || !boothId) {
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-6 lg:mb-8">
          ...
          <div className="flex gap-2 w-full sm:w-auto shrink-0">
            <button
              ...
              className="flex items-center justify-center gap-1.5 bg-brand-600 text-white hover:bg-brand-500 h-9 px-4 text-[13px] font-bold rounded-lg transition-all duration-150 flex-1 sm:flex-initial shadow-md shadow-brand-100"
            >
